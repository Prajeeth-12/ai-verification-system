...
async def extract_text_endpoint(file: UploadFile = File(...)):
    ...
    try:
        ...
        if provider is None and metadata.get("providers_used"):
            provider = metadata.get("providers_used")[0]
        ...
        return {
            ...
            "fallback_used": metadata.get("fallback_used", False) or (metadata.get("fallback_reason") is not None),
            "metadata": metadata
        }
